...
const envSchema = z.object({
    ...
    CURSOR_LLM_RUNTIME: z.string().min(1).optional(),
    CURSOR_CLOUD_REPO: z.string().url().optional(),
    CURSOR_CLOUD_REF: z.string().min(1).optional(),
    ...
    INTERVIEW_VERIFY_MODEL: z.string().min(1).optional(),
